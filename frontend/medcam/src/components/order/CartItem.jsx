        ...
        <div className="flex items-center gap-2 mt-2">
          <button
            ...
            className="w-8 h-8 rounded-full border border-slate-200 flex items-center justify-center
              ...
              transition-all duration-150 active:scale-95 text-sm font-bold"
          >
            −
          </button>
          ...
          <button
            onClick={() => onQuantityChange(medicamentId, quantity + 1)}
            className="w-8 h-8 rounded-full border border-slate-200 flex items-center justify-center
              text-slate-600 hover:bg-slate-50 transition-all duration-150 active:scale-95 text-sm font-bold"
          >
>>>>>>> Stashed changes
            +
          </button>
...
=======
      ...
      <div className="flex flex-col items-end gap-2 flex-shrink-0">
        ...
        <button
          ...
          className="w-7 h-7 rounded-lg border border-red-100 bg-red-50 flex items-center justify-center
            text-red-400 hover:text-red-600 hover:bg-red-100 transition-all duration-150 active:scale-95"
        >
>>>>>>> Stashed changes
